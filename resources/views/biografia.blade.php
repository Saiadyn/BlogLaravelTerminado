...
@section('content')
    <h1 class="text-center">Página de la biografía</h1>
    <div class="media border border-dark p-3 mt-2">
        <img src="/imgs/fede.jpg" class="mr-3 mt-3 rounded-circle" style="width:200px">
        <div class="media-body">
          <p class="h4">Federico García Lorca</p>
          <p class="mt-2">
